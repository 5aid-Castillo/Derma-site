...
<head>
    ...
    <link rel="stylesheet" href="css/estilos-redes.css?v=2">
...
<body>
    <header class="header">
        ...
        <img src="./img/greenPink.jpg" alt="Green">
        <div class="socialContent container">
            <div class="socialText">
                <h1 class="title-r">¡Síguenos en redes sociales!</h1>
            </div>
        </div>
    </div>
        <section class="section">
        <h4 class="info-r">Mantente informado de todas las promociones que tenemos para ti.</h4>
        <div class="redes">
            <ul class="wrapper">
